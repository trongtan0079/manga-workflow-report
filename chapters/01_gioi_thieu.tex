...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|c|p{4cm}|p{3.5cm}|X|}
        \hline
        \textbf{STT} & \textbf{Họ và tên} & \textbf{Vai trò} & \textbf{Email} \\
        \hline
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|p{4.5cm}|X|}
        \hline
        \textbf{Đối tượng} & \textbf{Mô tả} & \textbf{Chức năng} \\
        \hline
        \multirow{5}{*}{\textbf{Admin}} & \multirow{5}{4.5cm}{Quản trị và giám sát hoạt động của toàn bộ hệ thống.} & Quản lý tài khoản người dùng. \\
        \cline{3-3}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|p{4.5cm}|X|}
        ...
        \textbf{Đối tượng} & \textbf{Mô tả} & \textbf{Chức năng} \\
        \hline
        \multirow{8}{*}{\textbf{Mangaka}} & \multirow{8}{4.5cm}{Tác giả chính chịu trách nhiệm sáng tác và quản lý tác phẩm Manga.} & Tạo hồ sơ giới thiệu Series mới và nộp bản thảo sơ bộ để trình lên Hội đồng xét duyệt. \\
        \cline{3-3}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|p{4.5cm}|X|}
        ...
        \textbf{Đối tượng} & \textbf{Mô tả} & \textbf{Chức năng} \\
        \hline
        \multirow{8}{*}{\textbf{Assistant}} & \multirow{8}{4.5cm}{Người hỗ trợ Mangaka thực hiện các công việc được phân công nhằm hoàn thiện tác phẩm.} & Xem danh sách công việc được giao. \\
        \cline{3-3}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|p{4.5cm}|X|}
        ...
        \textbf{Đối tượng} & \textbf{Mô tả} & \textbf{Chức năng} \\
        \hline
        \multirow{5}{*}{\textbf{Tantou Editor}} & \multirow{5}{4.5cm}{Biên tập viên chịu trách nhiệm theo dõi và kiểm duyệt nội dung Manga trước khi phát hành.} & Review bản thảo Series và Chapter. \\
        \cline{3-3}
...
\begin{table}[H]
    ...
    \begin{tabularx}{\textwidth}{|l|p{4.5cm}|X|}
        ...
        \textbf{Đối tượng} & \textbf{Mô tả} & \textbf{Chức năng} \\
        \hline
        \multirow{7}{*}{\textbf{Editorial Board}} & \multirow{7}{4.5cm}{Hội đồng biên tập chịu trách nhiệm đánh giá hiệu quả phát hành và đưa ra các quyết định liên quan đến xuất bản Manga.} & Đánh giá hồ sơ giới thiệu Series mới. \\
        \cline{3-3}
