...
\textbf{Mô tả} & Tạo các trang trống (Page) để chuẩn bị cho quá trình vẽ và phân công công việc. \\ \hline
\textbf{Tiền điều kiện (Pre-conditions)} & Chapter đã được tạo thành công và người dùng được cấp quyền biên tập nội dung. \\ \hline
\textbf{Luồng sự kiện chính (Basic Flow)} & 
\begin{minipage}[t]{\linewidth}
    \begin{enumerate}[leftmargin=*]
        \item Người dùng vào giao diện chi tiết Chapter.
        \item Người dùng chọn 'Thêm Page'.
...
\begin{minipage}[t]{\linewidth}
    ...
    \end{itemize}
\end{minipage} \\ \hline
\textbf{Hậu điều kiện (Post-conditions)} & Tọa độ Annotation và kết quả Review được lưu trữ vĩnh viễn, trạng thái Task thay đổi tương ứng. \\ \hline
\end{tabularx}
...
\begin{minipage}[t]{\linewidth}
    ...
    \end{itemize}
\end{minipage} \\ \hline
\textbf{Hậu điều kiện (Post-conditions)} & Bảng xếp hạng của kỳ phát hành được cập nhật và đóng băng chỉnh sửa. \\ \hline
\end{tabularx}
