...
\begin{tabularx}{\textwidth}{|p{1.2cm}|>{\raggedright\arraybackslash}X|p{4.2cm}|p{2cm}|}
\hline
...
WBS 1.2 & Phân tích các Actor, luồng màn hình và Use Case tổng quát & G. T. N. Hân (Chính), N. T. Thảo, D. K. Ngân & 6 \\ \hline
WBS 1.3 & Đặc tả chi tiết Use Case chức năng Module 1 & G. T. N. Hân (Chính), N. T. Thảo & 8 \\ \hline
WBS 1.4 & Đặc tả chi tiết Use Case chức năng Module 2 & N. T. Thảo (Chính), G. T. N. Hân, D. K. Ngân & 10 \\ \hline
\textbf{WBS 2} & \textbf{Phase 2: Thiết kế hệ thống \& Cơ sở dữ liệu (SDD)} & Cả nhóm & \textbf{24} \\ \hline
WBS 2.1 & Thiết kế kiến trúc, mô hình triển khai và Component diagram & N. T. Trúc Ngân (Chính), T. T. Tấn & 6 \\ \hline
WBS 2.2 & Thiết kế Class Diagram chi tiết và các phương thức & N. T. Trúc Ngân (Chính), Cả nhóm & 6 \\ \hline
WBS 2.3 & Thiết kế CSDL vật lý, sơ đồ ERD và Data Dictionary & P. T. Hạnh (Chính), N. T. Trúc Ngân & 6 \\ \hline
WBS 2.4 & Thiết kế giao diện UI Mockup và Wireframes & P. T. Hạnh (Chính), N. T. Thảo & 6 \\ \hline
\textbf{WBS 3} & \textbf{Phase 3: Phát triển \& Lập trình ứng dụng (Coding)} & Cả nhóm & \textbf{30} \\ \hline
WBS 3.1 & Lập trình module Đăng nhập, Quản lý tài khoản và Phân quyền & G. T. N. Hân (Chính), T. T. Tấn, N. T. Trúc Ngân & 8 \\ \hline
WBS 3.2 & Lập trình module Quản lý Series và Chapter & N. T. Thảo (Chính), G. T. N. Hân & 6 \\ \hline
WBS 3.3 & Lập trình module Quản lý Task, Submission và Review & P. T. Hạnh (Chính), N. T. Thảo, D. K. Ngân & 8 \\ \hline
WBS 3.4 & Lập trình module Bình chọn, Xếp hạng và Thông báo & N. T. Trúc Ngân (Chính), P. T. Hạnh, T. T. Tấn & 8 \\ \hline
\textbf{WBS 4} & \textbf{Phase 4: Kiểm thử, tài liệu \& Bàn giao (QA \& Deployment)} & Cả nhóm & \textbf{16} \\ \hline
WBS 4.1 & Chuẩn hóa yêu cầu phi chức năng (NFR) và kịch bản kiểm thử & D. K. Ngân (Chính), G. T. N. Hân & 6 \\ \hline
WBS 4.2 & Thực hiện chạy thử nghiệm, log lỗi và lập Báo cáo kiểm thử & D. K. Ngân (Chính), Cả nhóm & 4 \\ \hline
WBS 4.3 & Viết tài liệu hướng dẫn cài đặt, sử dụng và đóng gói sản phẩm & P. T. Hạnh (Chính), Cả nhóm & 4 \\ \hline
