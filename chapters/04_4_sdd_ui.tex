...
Bảng điều khiển chung cho từng vai trò, hiển thị các thông tin tổng quan, biểu đồ tiến độ và các tác vụ khẩn cấp.
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_dashboard.png}
    \caption{Mockup giao diện Dashboard tổng quát}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_login.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_series.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_chapter.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_task.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_submission.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_review.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_notification.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{Chapter4_IMAGE/ui_ranking.png}
