...
% Định nghĩa bảng màu chuyên nghiệp
\definecolor{navyblue}{RGB}{27, 54, 93}      % Xanh Navy đậm, học thuật
\definecolor{charcoal}{RGB}{51, 51, 51}      % Xám đậm cho chữ chính
\definecolor{lightgray}{RGB}{245, 247, 250}   % Nền xám nhạt cho code
\definecolor{bordergray}{RGB}{220, 224, 230}  % Màu viền cho bảng/code
\definecolor{linkblue}{RGB}{20, 80, 160}      % Màu xanh nhã nhặn cho link
\definecolor{citegreen}{RGB}{40, 120, 40}     % Màu xanh lá cây đậm cho trích dẫn
...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\itshape\color{navyblue}\leftmark}
\fancyhead[R]{\bfseries\color{navyblue}\thepage}
